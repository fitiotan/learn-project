                                                ...
                                                echo "<div class='col mb-5'>";
                                                    echo "<div class='card h-100'>";
                                                        ...
                                                        echo "<div class='card-footer p-4 pt-0 border-top-0 bg-transparent'>";
                                                            echo "<div class='text-center'>";
                                                                echo "<form method='POST' action='resource.php'>";                                                                     
                                                                    echo "<button class='btn btn-outline-dark mt-auto' type='submit' name='enter' value=".$row['name'].">";
                                                                        echo "進入";
                                                                    echo "</button>";
                                                                echo "</form>";
                                                            echo "</div>";;
